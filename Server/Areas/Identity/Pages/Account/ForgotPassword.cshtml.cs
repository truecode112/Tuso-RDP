        ...
        public async Task<IActionResult> OnPostAsync()
        {
            if (ModelState.IsValid)
            {
                ...
                var emailResult = await _emailSender.SendEmailAsync(
                    Input.Email,
                    "Reset Password",
                    $"<img src='{Request.Scheme}://{Request.Host}/images/Tuso_logo.jpg'/><br><br>Please reset your Remotely password by <a href='{HtmlEncoder.Default.Encode(callbackUrl)}'>clicking here</a>.");
